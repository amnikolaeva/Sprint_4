...
public class RentPage extends AbstractPageObject {
    ...
    private static final By DATE_FIELD = By.xpath(".//div[@class='react-datepicker__input-container']/input[@class='Input_Input__1iN_Z Input_Responsible__1jDKN']");
    private static final By DATE_IN_CALENDAR = By.xpath(".//div[@class='react-datepicker']/div[@class='react-datepicker__month-container']/div[@class='react-datepicker__month']/div[@class='react-datepicker__week'][4]/div[@class='react-datepicker__day react-datepicker__day--025 react-datepicker__day--weekend']");
    ...
    private static final By ORDER_BUTTON = By.xpath(".//div[@class='Order_Buttons__1xGrp']/button[@class='Button_Button__ra12g Button_Middle__1CSJM']");
